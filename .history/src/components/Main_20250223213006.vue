...
<template>
  ...
  <section class="p-4 bg-green pt-0 rd-form">
    <div class="container">
      <div class="p-4 pt-2 pb-2" style="background-color: white; border-radius: 24px;">
      ...
      <el-form
          ...
          label-width="auto"
        >
          <el-form-item size="large" label="护照号" prop="pptNo" style="margin: 10px 0;">
            <el-input
          ...
          <el-form-item size="large" label="航班号" prop="fltNo" style="margin: 10px 0;">
            <el-input
          ...
          <el-form-item size="large" label="座位号" prop="setNo" style="margin: 10px 0;">
            <el-input
