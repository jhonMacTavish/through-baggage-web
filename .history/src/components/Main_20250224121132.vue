 ...
 * @LastEditTime: 2025-02-24 12:10:57
...
<template>
  ...
  <footer class="p-5 bg-dark text-center text-white w-100">
      <div class="container">
        <p class="lead">Copyright &copy; 2021 我在B站玩编程</p>
      </div>
    </footer>
</template>
...
const changeLang = (type: string) => {
  ...
  rules.fltNo[0].validator = createValidator(/^[G|E|P|S|D|C]\d{8}$/, t('messages.userText.validateText.flightNo'));
  rules.setNo[0].validator = createValidator(/^[G|E|P|S|D|C]\d{8}$/, t('messages.userText.validateText.seatNo'));
};
