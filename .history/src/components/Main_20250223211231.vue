 ...
 * @LastEditTime: 2025-02-23 21:11:55
...
<template>
  ...
  <section class="bg-green rd-form pb-4">
    <div class="container p-4 bg-white mb-4">
        ...
        <el-form
          ...
          label-width="auto"
        >
          <el-form-item size="large" label="护照号" prop="pptNo" label-style="">
            <el-input
          ...
          <el-form-item size="large" label="航班号" prop="fltNo">
            <el-input
          ...
          <el-form-item size="large" label="座位号" prop="setNo">
            <el-input
