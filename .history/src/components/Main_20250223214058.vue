 ...
 * @LastEditTime: 2025-02-23 21:40:58
    ...
    <div class="container">
      <div class="p-4" style="background-color: white; border-radius: 24px">
        ...
        <el-form
          ...
          label-width="auto"
        >
          <el-form-item class="item-marginBt" size="large" label="护照号" prop="pptNo">
            <el-input
          ...
          <el-form-item class="item-marginBt" size="large" label="航班号" prop="fltNo">
            <el-input
          ...
          <el-form-item class="item-marginBt" size="large" label="座位号" prop="setNo">
            <el-input
