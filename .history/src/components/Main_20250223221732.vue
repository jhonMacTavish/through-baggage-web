 ...
 * @LastEditTime: 2025-02-23 22:16:22
...
<template>
  <section class="pt-3 pb-3 bg-green">
    <div class="container">
      <h2 class="text-center text-white">通程行李状态</h2>
    </div>
  </section>
  ...
  <section class="p-4 bg-green pt-0 rd-form">
    <div class="container">
      <div class="p-4 form-bg">
        <h6 class="form-title">请输入行程信息，查询行李状态</h6>
        <el-form
          ref="ruleFormRef"
          :model="ruleForm"
          status-icon
  ...
  <section class="p-4 flex1">
    <div class="container">
      <h6 class="info-title mb-3">行李状态：</h6>
      <div class="info-content p-4 d-flex justify-content-center align-items-center">
        <p class="text-center ">
          {{ prompt.str1 }}<br /><span>{{ prompt.str2 }}</span>
        </p>
      </div>
    </div>
  </section>

  <footer class="p-2 pb-1 text-center">
    <div class="container">
...
const submitForm = async (formEl: FormInstance | undefined) => {
  ...
  try {
    ...
    if (valid) {
      ...
      prompt.str1 = prompts.res1.str1;
      prompt.str2 = prompts.res1.str2;
